...
public class Constants {
    ...
    public static Map<String, List<String>> getRolesRights() {
        ...
        // se va modifica in functie de ce functionalitati dorim, libera alegere
        ...
        rolesRights.get(CUSTOMER).addAll(Arrays.asList(SELL_BOOK, BUY_BOOK, RETURN_BOOK)); // sell book poate sa incarce pe platforma carti-> complexitate cresuta
